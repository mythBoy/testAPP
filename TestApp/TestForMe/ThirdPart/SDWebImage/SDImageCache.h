...
typedef NS_ENUM(NSInteger, SDImageCacheType) {
    /**
     * The image wasn't available the SDWebImage caches, but was downloaded from the web. 图片缓存中没有，只能网上下载
     */
    SDImageCacheTypeNone,
    /**
     * The image was obtained from the disk cache. 该图片是从磁盘缓存中获得的。
     */
    SDImageCacheTypeDisk,
    /**
     * The image was obtained from the memory cache. 该图片是从内存缓存中获得的。
     */
