...
//                    NewWeiBo *weibo = [NewWeiBo weiboWithDict:dict];
//                    
//                    // 根据模型数据创建frame模型
//                    NewWeiBo *wbF = [[NewWeiBo alloc] init];
...
//{
//    NewWeiBoCell *cell = [NewWeiBoCell cellWithTableView:tableView];
//    // 3.设置数据
...
//    // 取出对应航的frame模型
//    NewWeiBo *wbF = self.statusFrames[indexPath.row];
