...
- (id)initWithFrame:(CGRect)frame {
    if(self = [super initWithFrame:frame]) {
        ...
        self.titles = [NSMutableArray arrayWithObjects:NSLocalizedString(@"刷新中...",),
...
//        self.wasTriggeredByUser = YES;
        ...
        _successView = [[UIView alloc]initWithFrame:CGRectMake(self.width/2-40, self.height/2-15, 100, 30)];
        _successView.backgroundColor = [UIColor clearColor];
        [self addSubview:_successView];
        
        UIImageView *successImage = [[UIImageView alloc]initWithFrame:CGRectMake(0, 5, 20, 20)];
        successImage.image = [UIImage imageNamed:@"Refresh successfully"];
        [_successView addSubview:successImage];
        
        UILabel *successLabel = [[UILabel alloc]initWithFrame:CGRectMake(20, 0, 80, 30)];
        successLabel.textColor = [UIColor grayColor];
        successLabel.text = @"刷新成功";
...
//        
        ...
        self.successView.frame = CGRectMake(self.width/2-40, self.height/2-15, 100, 30);
    }
}
...
- (void)resetScrollViewContentInset {
    ...
    [UIView animateWithDuration:0.3 delay:0.5 options:UIViewAnimationOptionAllowUserInteraction|UIViewAnimationOptionBeginFromCurrentState animations:^{
...
- (SVPullToRefreshArrow *)arrow {
    if(!_arrow) {
        _arrow = [[SVPullToRefreshArrow alloc]initWithFrame:CGRectMake(0, self.bounds.size.height-54, 0, 0)];
...
- (UIActivityIndicatorView *)activityIndicatorView {
    if(!_activityIndicatorView) {
        ...
        _activityIndicatorView.frame = CGRectMake(0, self.bounds.size.height-54, 22, 48);
